...
public class ClearGLWindow implements ClearGLDisplayable
{
  ...
  static class MultisampleChooser extends DefaultGLCapabilitiesChooser
  {
                                  ...
                                  final int windowSystemRecommendedChoice)
    {
      ...
      final int selection =
                          super.chooseCapabilities(desired,
                                                   available,
      ...
      {
        final GLCapabilitiesImmutable caps =
                                           (GLCapabilitiesImmutable) available.get(selection);
                       ...
                       final ClearGLEventListener pClearGLWindowEventListener)
  {
    ...
    final GLCapabilitiesChooser lMultisampleChooser =
                                                    new MultisampleChooser();
  ...
  public void setFullscreen(final boolean pFullScreen)
  {
    if (pFullScreen)
    {
      ...
      // 0
      final ArrayList<MonitorDevice> monitors =
      ...
      {
        lFullscreen =
                    Integer.parseInt(System.getProperty("ClearGL.FullscreenDevice"));
  ...
  {
    final com.jogamp.nativewindow.util.Rectangle bounds =
                                                        mGlWindow.getBounds();
    return new float[]
    { bounds.getX(),
      bounds.getY(),
